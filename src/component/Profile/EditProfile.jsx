...
const EditProfile = ({ Userbio, Username, Useryear, open, setOpen,sendData }) => {
  ...
  const updateDetail = async (data) => {
    ...
    // console.log(data)
    setLoading(true);
    let result = await fetch(`https://club-community-feedbox2-0-sdcn-f4nbfkrt9-feedboxs-projects.vercel.app/updateDetail/${data}`, {
      method: "put",
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await fetch(`https://club-community-feedbox2-0-sdcn-f4nbfkrt9-feedboxs-projects.vercel.app/update/details/pic/${id}`, {
      method: "PUT",
      body: fdata,
      headers: {
        Authorization: "Bearer " + localStorage.getItem("jwt")
    ...
    if (currentUser && currentUser.imgId) {
      const data = await fetch(`https://club-community-feedbox2-0-sdcn-f4nbfkrt9-feedboxs-projects.vercel.app/delete/image/user/${currentUser.imgId}`, {
        method: "DELETE",
        body: fdata,
        headers: {
          Authorization: "Bearer " + localStorage.getItem("jwt")
