...
const ProfileRes = () => {
  ...
  const getResource = async () => {
    setLoading(true);
    let result = await fetch("https://club-community-feedbox2-0-sdcn-f4nbfkrt9-feedboxs-projects.vercel.app/myResource", {
      headers: {
  ...
  const deleteRes = async (item) => {
    console.log(item);
    if (item.type === "pdf") {
      let result = await fetch(`https://club-community-feedbox2-0-sdcn-f4nbfkrt9-feedboxs-projects.vercel.app/delete/Resource/pdf`, {
        method: "delete",
      ...
      let result = await fetch(`https://club-community-feedbox2-0-sdcn-f4nbfkrt9-feedboxs-projects.vercel.app/delete/Resource/link/${item._id}`, {
        method: "delete",
      });
      result = await result.json();
      addToast(result, { appearance: "success" })
